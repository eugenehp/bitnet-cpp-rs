...
use bitnet_cpp_sys::llama_token;
use std::cmp::min;
use std::ptr;
...
impl LlamaTokenDataArray {
    ...
    //     &mut self,
    //     modify: impl FnOnce(&mut bitnet_cpp_sys::llama_token_data_array) -> T,
    // ) -> T {
    //     let size = self.data.len();
    //     let data = self.data.as_mut_ptr().cast();
    //     let mut c_llama_token_data_array = bitnet_cpp_sys::llama_token_data_array {
    //         data,
    //         size,
    //         sorted: self.sorted,
    //     };
    ...
    //             bitnet_cpp_sys::llama_sample_repetition_penalties(
    //                 ctx,
    ...
    //         let ctx = ctx.map_or(ptr::null_mut(), |ctx| ctx.context.as_ptr());
    //         self.modify_as_c_llama_token_data_array(|c_llama_token_data_array| {
    //             bitnet_cpp_sys::llama_sample_softmax(ctx, c_llama_token_data_array);
    //         });
    //     }
    // }
    ...
    //     unsafe {
    //         self.modify_as_c_llama_token_data_array(|c_llama_token_data_array| {
    //             bitnet_cpp_sys::llama_sample_temp(ctx, c_llama_token_data_array, temperature);
    //         });
    //     }
    // }
    ...
    //         self.modify_as_c_llama_token_data_array(|c_llama_token_data_array| {
    //             bitnet_cpp_sys::llama_sample_token(ctx.context.as_ptr(), c_llama_token_data_array)
    //         })
    //     };
    ...
    //     unsafe {
    //         self.modify_as_c_llama_token_data_array(|c_llama_token_data_array| {
    //             bitnet_cpp_sys::llama_sample_top_k(ctx, c_llama_token_data_array, k, min_keep);
    //         });
    //     }
    // }
    ...
    //     unsafe {
    //         self.modify_as_c_llama_token_data_array(|c_llama_token_data_array| {
    //             bitnet_cpp_sys::llama_sample_tail_free(ctx, c_llama_token_data_array, z, min_keep);
    //         });
    //     }
    // }
    ...
    //     unsafe {
    //         self.modify_as_c_llama_token_data_array(|c_llama_token_data_array| {
    //             bitnet_cpp_sys::llama_sample_typical(ctx, c_llama_token_data_array, p, min_keep);
    //         });
    //     }
    // }
    ...
    //     unsafe {
    //         self.modify_as_c_llama_token_data_array(|c_llama_token_data_array| {
    //             bitnet_cpp_sys::llama_sample_top_p(ctx, c_llama_token_data_array, p, min_keep);
    //         });
    //     }
    // }
    ...
    //     let token = unsafe {
    //         self.modify_as_c_llama_token_data_array(|c_llama_token_data_array| {
    //             bitnet_cpp_sys::llama_sample_token_mirostat_v2(
    //                 ctx.context.as_ptr(),
    //                 c_llama_token_data_array,
    //                 tau,
    //                 eta,
    ...
    //     let token = unsafe {
    //         self.modify_as_c_llama_token_data_array(|c_llama_token_data_array| {
    //             bitnet_cpp_sys::llama_sample_token_mirostat(
    //                 ctx.context.as_ptr(),
    //                 c_llama_token_data_array,
    //                 tau,
    //                 eta,
