...
use bitnet_cpp_sys::{ggml_time_us, llama_perf_context_print};
...
pub struct PerfContextData {
    pub(crate) perf_context_data: bitnet_cpp_sys::llama_perf_context_data,
}
...
impl PerfContextData {
    ...
    pub fn new(
        ...
        Self {
            perf_context_data: bitnet_cpp_sys::llama_perf_context_data {
                t_start_ms,
                // t_end_ms,
                t_load_ms,
                // t_sample_ms,
