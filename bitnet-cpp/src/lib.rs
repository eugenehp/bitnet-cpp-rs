...
pub fn llama_time_us() -> i64 {
    unsafe { bitnet_cpp_sys::llama_time_us() }
}
...
pub fn max_devices() -> usize {
    unsafe { bitnet_cpp_sys::llama_max_devices() }
}
...
pub fn mmap_supported() -> bool {
    unsafe { bitnet_cpp_sys::llama_supports_mmap() }
}
...
pub fn mlock_supported() -> bool {
    unsafe { bitnet_cpp_sys::llama_supports_mlock() }
}
...
pub fn ggml_time_us() -> i64 {
    unsafe { bitnet_cpp_sys::ggml_time_us() }
}
