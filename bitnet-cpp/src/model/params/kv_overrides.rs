...
impl ParamOverrideValue {
    pub(crate) fn tag(&self) -> bitnet_cpp_sys::llama_model_kv_override_type {
        match self {
            ParamOverrideValue::Bool(_) => bitnet_cpp_sys::LLAMA_KV_OVERRIDE_TYPE_BOOL,
            ParamOverrideValue::Float(_) => bitnet_cpp_sys::LLAMA_KV_OVERRIDE_TYPE_FLOAT,
            ParamOverrideValue::Int(_) => bitnet_cpp_sys::LLAMA_KV_OVERRIDE_TYPE_INT,
            ParamOverrideValue::Str(_) => bitnet_cpp_sys::LLAMA_KV_OVERRIDE_TYPE_STR,
        }
    }

    pub(crate) fn value(&self) -> bitnet_cpp_sys::llama_model_kv_override__bindgen_ty_1 {
        match self {
            ParamOverrideValue::Bool(value) => {
                bitnet_cpp_sys::llama_model_kv_override__bindgen_ty_1 { val_bool: *value }
            }
            ParamOverrideValue::Float(value) => {
                bitnet_cpp_sys::llama_model_kv_override__bindgen_ty_1 { val_f64: *value }
            }
            ParamOverrideValue::Int(value) => {
                bitnet_cpp_sys::llama_model_kv_override__bindgen_ty_1 { val_i64: *value }
            }
            ParamOverrideValue::Str(c_string) => {
                bitnet_cpp_sys::llama_model_kv_override__bindgen_ty_1 { val_str: *c_string }
            }
        }
    }
}

impl From<&bitnet_cpp_sys::llama_model_kv_override> for ParamOverrideValue {
    fn from(
        bitnet_cpp_sys::llama_model_kv_override {
            key: _,
            tag,
            __bindgen_anon_1,
        }: &bitnet_cpp_sys::llama_model_kv_override,
        ...
        match *tag {
            bitnet_cpp_sys::LLAMA_KV_OVERRIDE_TYPE_INT => {
                ParamOverrideValue::Int(unsafe { __bindgen_anon_1.val_i64 })
            }
            bitnet_cpp_sys::LLAMA_KV_OVERRIDE_TYPE_FLOAT => {
                ParamOverrideValue::Float(unsafe { __bindgen_anon_1.val_f64 })
            }
            bitnet_cpp_sys::LLAMA_KV_OVERRIDE_TYPE_BOOL => {
                ParamOverrideValue::Bool(unsafe { __bindgen_anon_1.val_bool })
            }
            bitnet_cpp_sys::LLAMA_KV_OVERRIDE_TYPE_STR => {
