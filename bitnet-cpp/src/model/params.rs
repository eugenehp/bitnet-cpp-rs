...
pub struct LlamaModelParams {
    pub(crate) params: bitnet_cpp_sys::llama_model_params,
    kv_overrides: Vec<bitnet_cpp_sys::llama_model_kv_override>,
}
...
impl LlamaModelParams {
    ...
    pub fn append_kv_override(
        ...
        self.kv_overrides
            .push(bitnet_cpp_sys::llama_model_kv_override {
                key: [0; 128],
                tag: 0,
                __bindgen_anon_1: bitnet_cpp_sys::llama_model_kv_override__bindgen_ty_1 {
                    val_i64: 0,
                },
            });
...
impl Default for LlamaModelParams {
    fn default() -> Self {
        let default_params = unsafe { bitnet_cpp_sys::llama_model_default_params() };
        LlamaModelParams {
