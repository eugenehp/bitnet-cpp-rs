...
// use bitnet_cpp_sys::{llama_grammar, llama_grammar_element, llama_gretype};
// use std::ptr::NonNull;
// use std::str::FromStr;
// use tracing::error;
...
//     fn clone(&self) -> Self {
//         let grammar = unsafe { bitnet_cpp_sys::llama_grammar_copy(self.grammar.as_ptr()) };
//         Self {
...
//                 type_: bitnet_cpp_sys::LLAMA_GRETYPE_ALT,
//                 value: 0,
//             });
...
//         }
//         rule.push(llama_grammar_element {
//             type_: bitnet_cpp_sys::LLAMA_GRETYPE_END,
//             value: 0,
//         });
...
//                     rest = r;
//                     rule.push(llama_grammar_element {
//                         type_: bitnet_cpp_sys::LLAMA_GRETYPE_CHAR,
//                         value: c as _,
//                     });
//                 }
...
//                     rest = &rest[1..];
//                     bitnet_cpp_sys::LLAMA_GRETYPE_CHAR_NOT
//                 } else {
//                     bitnet_cpp_sys::LLAMA_GRETYPE_CHAR
//                 };
//                 last_sym_start = rule.len();
//                 while !rest.starts_with(']') {
//                     let (c, r) = Self::parse_char(rest)?;
...
//                         bitnet_cpp_sys::LLAMA_GRETYPE_CHAR_ALT
//                     } else {
//                         start_type
//                     };
//                     rule.push(llama_grammar_element {
...
//                         rest = r;
//                         rule.push(llama_grammar_element {
//                             type_: bitnet_cpp_sys::LLAMA_GRETYPE_CHAR_RNG_UPPER,
//                             value: c as _,
//                         });
//                     }
//                 }
...
//                 last_sym_start = rule.len();
//                 rule.push(llama_grammar_element {
//                     type_: bitnet_cpp_sys::LLAMA_GRETYPE_RULE_REF,
//                     value: ref_rule_id,
//                 });
//             } else if first_char == '(' {
...
//         let grammar =
//             unsafe { bitnet_cpp_sys::llama_grammar_init(rules, n_rules, root_id as usize) };
...
//     fn drop(&mut self) {
//         unsafe { bitnet_cpp_sys::llama_grammar_free(self.grammar.as_ptr()) }
//     }
// }
