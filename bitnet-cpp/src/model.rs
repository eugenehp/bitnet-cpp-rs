...
pub struct LlamaModel {
    pub(crate) model: NonNull<bitnet_cpp_sys::llama_model>,
}
...
pub struct LlamaLoraAdapter {
    pub(crate) lora_adapter: NonNull<bitnet_cpp_sys::llama_lora_adapter>,
}
...
impl LlamaModel {
    ...
    pub fn n_ctx_train(&self) -> u32 {
        let n_ctx_train = unsafe { bitnet_cpp_sys::llama_n_ctx_train(self.model.as_ptr()) };
    ...
    pub fn token_bos(&self) -> LlamaToken {
        let token = unsafe { bitnet_cpp_sys::llama_token_bos(self.model.as_ptr()) };
        LlamaToken(token)
    }
    ...
    pub fn token_eos(&self) -> LlamaToken {
        let token = unsafe { bitnet_cpp_sys::llama_token_eos(self.model.as_ptr()) };
        LlamaToken(token)
    }
    ...
    pub fn token_nl(&self) -> LlamaToken {
        let token = unsafe { bitnet_cpp_sys::llama_token_nl(self.model.as_ptr()) };
        LlamaToken(token)
    }
    ...
    pub fn is_eog_token(&self, token: LlamaToken) -> bool {
        unsafe { bitnet_cpp_sys::llama_token_is_eog(self.model.as_ptr(), token.0) }
    }
    ...
    pub fn token_attr(&self, LlamaToken(id): LlamaToken) -> LlamaTokenAttrs {
        let token_type = unsafe { bitnet_cpp_sys::llama_token_get_attr(self.model.as_ptr(), id) };
    ...
    pub fn token_to_bytes_with_size(
        ...
        let size = unsafe {
            bitnet_cpp_sys::llama_token_to_piece(
                self.model.as_ptr(),
                token.0,
                buf,
                len,
    ...
    pub fn n_vocab(&self) -> i32 {
        unsafe { bitnet_cpp_sys::llama_n_vocab(self.model.as_ptr()) }
    }
    ...
    pub fn vocab_type(&self) -> VocabType {
        let vocab_type = unsafe { bitnet_cpp_sys::llama_vocab_type(self.model.as_ptr()) };
    ...
    pub fn n_embd(&self) -> c_int {
        unsafe { bitnet_cpp_sys::llama_n_embd(self.model.as_ptr()) }
    }
    ...
    pub fn get_chat_template(&self, buf_size: usize) -> Result<String, ChatTemplateError> {
        ...
        let ret = unsafe {
            bitnet_cpp_sys::llama_model_meta_val_str(
                self.model.as_ptr(),
                chat_name.as_ptr(),
                chat_ptr,
                buf_size,
    ...
    pub fn load_from_file(
        ...
        let llama_model =
            unsafe { bitnet_cpp_sys::llama_load_model_from_file(cstr.as_ptr(), params.params) };
    ...
    pub fn lora_adapter_init(
        ...
        let cstr = CString::new(path)?;
        let adapter =
            unsafe { bitnet_cpp_sys::llama_lora_adapter_init(self.model.as_ptr(), cstr.as_ptr()) };
    ...
    pub fn new_context(
        ...
        let context = unsafe {
            bitnet_cpp_sys::llama_new_context_with_model(self.model.as_ptr(), context_params)
        };
    ...
    pub fn apply_chat_template(
        ...
        // Build our bitnet_cpp_sys chat messages
        let chat: Vec<bitnet_cpp_sys::llama_chat_message> = chat
            .iter()
            .map(|c| bitnet_cpp_sys::llama_chat_message {
                role: c.role.as_ptr(),
        ...
        let formatted_chat = unsafe {
            let res = bitnet_cpp_sys::llama_chat_apply_template(
                self.model.as_ptr(),
                tmpl_ptr,
                chat.as_ptr(),
                chat.len(),
...
impl Drop for LlamaModel {
    fn drop(&mut self) {
        unsafe { bitnet_cpp_sys::llama_free_model(self.model.as_ptr()) }
    }
}
...
pub enum VocabType {
    /// Byte Pair Encoding
    BPE = bitnet_cpp_sys::LLAMA_VOCAB_TYPE_BPE as _,
    /// Sentence Piece Tokenizer
    SPM = bitnet_cpp_sys::LLAMA_VOCAB_TYPE_SPM as _,
}
...
pub enum LlamaTokenTypeFromIntError {
    ...
    UnknownValue(bitnet_cpp_sys::llama_vocab_type),
}

impl TryFrom<bitnet_cpp_sys::llama_vocab_type> for VocabType {
    type Error = LlamaTokenTypeFromIntError;

    fn try_from(value: bitnet_cpp_sys::llama_vocab_type) -> Result<Self, Self::Error> {
        match value {
            bitnet_cpp_sys::LLAMA_VOCAB_TYPE_BPE => Ok(VocabType::BPE),
            bitnet_cpp_sys::LLAMA_VOCAB_TYPE_SPM => Ok(VocabType::SPM),
